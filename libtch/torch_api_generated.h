...
void atg_linalg_qr(tensor *, tensor self, char* mode_ptr, int mode_len);
void atg_linalg_qr_out(tensor *, tensor Q, tensor R, tensor self, char* mode_ptr, int mode_len);
