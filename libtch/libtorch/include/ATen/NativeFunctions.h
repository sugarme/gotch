...
CAFFE2_API Tensor mv_cpu(const Tensor & self, const Tensor & vec);
CAFFE2_API Tensor & mv_cpu_out(Tensor & out, const Tensor & self, const Tensor & vec);
...
CAFFE2_API Tensor & scatter_cpu_(Tensor & self, int64_t dim, const Tensor & index, const Tensor & src);
CAFFE2_API Tensor scatter(const Tensor & self, int64_t dim, const Tensor & index, const Tensor & src);
CAFFE2_API Tensor & scatter_fill_cpu_(Tensor & self, int64_t dim, const Tensor & index, Scalar value);
...
CAFFE2_API Tensor & scatter_add_cpu_(Tensor & self, int64_t dim, const Tensor & index, const Tensor & src);
...
CAFFE2_API Tensor & random_(Tensor & self, int64_t from, c10::optional<int64_t> to, Generator * generator=nullptr);
...
CAFFE2_API Tensor & normal_cpu_(Tensor & self, double mean=0, double std=1, Generator * generator=nullptr);
CAFFE2_API Tensor & normal_cuda_(Tensor & self, double mean=0, double std=1, Generator * generator=nullptr);
CAFFE2_API Tensor & normal_out_cpu(Tensor & out, const Tensor & mean, double std=1, Generator * generator=nullptr);
CAFFE2_API Tensor & normal_out_cuda(Tensor & out, const Tensor & mean, double std=1, Generator * generator=nullptr);
CAFFE2_API Tensor normal_cpu(const Tensor & mean, double std=1, Generator * generator=nullptr);
CAFFE2_API Tensor normal_cuda(const Tensor & mean, double std=1, Generator * generator=nullptr);
CAFFE2_API Tensor & normal_out_cpu(Tensor & out, double mean, const Tensor & std, Generator * generator=nullptr);
CAFFE2_API Tensor & normal_out_cuda(Tensor & out, double mean, const Tensor & std, Generator * generator=nullptr);
CAFFE2_API Tensor normal_cpu(double mean, const Tensor & std, Generator * generator=nullptr);
CAFFE2_API Tensor normal_cuda(double mean, const Tensor & std, Generator * generator=nullptr);
CAFFE2_API Tensor & normal_out_cpu(Tensor & out, const Tensor & mean, const Tensor & std, Generator * generator=nullptr);
CAFFE2_API Tensor & normal_out_cuda(Tensor & out, const Tensor & mean, const Tensor & std, Generator * generator=nullptr);
CAFFE2_API Tensor normal_cpu(const Tensor & mean, const Tensor & std, Generator * generator=nullptr);
...
CAFFE2_API Tensor & quantized_elu_out(Tensor & out, const Tensor & self, Scalar alpha=1, Scalar scale=1, Scalar input_scale=1);
CAFFE2_API Tensor elu(const Tensor & self, Scalar alpha=1, Scalar scale=1, Scalar input_scale=1);
CAFFE2_API Tensor quantized_elu(const Tensor & self, Scalar alpha=1, Scalar scale=1, Scalar input_scale=1);
...
CAFFE2_API Tensor & quantized_elu_(Tensor & self, Scalar alpha=1, Scalar scale=1, Scalar input_scale=1);
...
CAFFE2_API Tensor & rrelu_with_noise_out_cpu(Tensor & out, const Tensor & self, const Tensor & noise, Scalar lower=0.125, Scalar upper=0.3333333333333333, bool training=false, Generator * generator=nullptr);
CAFFE2_API Tensor rrelu_with_noise_cpu(const Tensor & self, const Tensor & noise, Scalar lower=0.125, Scalar upper=0.3333333333333333, bool training=false, Generator * generator=nullptr);
...
CAFFE2_API Tensor & rrelu_with_noise_cpu_(Tensor & self, const Tensor & noise, Scalar lower=0.125, Scalar upper=0.3333333333333333, bool training=false, Generator * generator=nullptr);
