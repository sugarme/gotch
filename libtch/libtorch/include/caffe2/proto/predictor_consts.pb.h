...
class CAFFE2_API PredictorConsts : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe2.PredictorConsts) */ {
 public:
  ...
  static const int kSHAPEINFOBLOBFieldNumber = 13;
  ...
  static const int kDEFERREDBLOBREADERFieldNumber = 14;
 ...
 private:
  ...
  void set_has_shape_info_blob();
  void clear_has_shape_info_blob();
  void set_has_deferred_blob_reader();
  void clear_has_deferred_blob_reader();
  ...
  public:
  static ::google::protobuf::internal::ExplicitlyConstructed< ::std::string> _i_give_permission_to_break_this_code_default_shape_info_blob_;
  private:
  ::google::protobuf::internal::ArenaStringPtr shape_info_blob_;
  public:
  static ::google::protobuf::internal::ExplicitlyConstructed< ::std::string> _i_give_permission_to_break_this_code_default_deferred_blob_reader_;
  private:
  ::google::protobuf::internal::ArenaStringPtr deferred_blob_reader_;
...
inline void PredictorConsts::set_has_shape_info_blob() {
  _has_bits_[0] |= 0x00001000u;
}
inline void PredictorConsts::clear_has_shape_info_blob() {
  _has_bits_[0] &= ~0x00001000u;
}
...
inline void PredictorConsts::set_has_deferred_blob_reader() {
  _has_bits_[0] |= 0x00002000u;
}
inline void PredictorConsts::clear_has_deferred_blob_reader() {
  _has_bits_[0] &= ~0x00002000u;
}
inline void PredictorConsts::clear_deferred_blob_reader() {
  ...
  clear_has_deferred_blob_reader();
}
